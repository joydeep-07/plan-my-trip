...
const Why: React.FC = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative p-4 mb-16 bg-[var(--bg-main)] md:mb-0 w-screen h-[500px] overflow-hidden"
    >
      ...
      {/* Overlay */}
      <div className="absolute inset-4 rounded-xl bg-[var(--text-main)]/40 pointer-events-none" />
      ...
      <div className="absolute inset-4 flex items-center justify-center pointer-events-none">
        <div
          className="
            ...
            backdrop-blur-md
            border border-[var(--bg-secondary)]/20
            text-center
        ...
        >
          ...
          {/* Features */}
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-6 pt-4 border-t border-[var(--bg-secondary)]/20">
            ...
            <div className="why-feature-item flex flex-col items-center text-center transform-gpu will-change-[transform,opacity]">
              <Map className="w-6 h-6 mb-2 text-amber-400" />
              <span className="text-xs sm:text-sm font-medium">
            ...
            <div className="why-feature-item flex flex-col items-center text-center transform-gpu will-change-[transform,opacity]">
              <Tag className="w-6 h-6 mb-2 text-amber-400" />
              <span className="text-xs sm:text-sm font-medium">
            ...
            <div className="why-feature-item flex flex-col items-center text-center transform-gpu will-change-[transform,opacity]">
              <Users className="w-6 h-6 mb-2 text-amber-400" />
              <span className="text-xs sm:text-sm font-medium">
